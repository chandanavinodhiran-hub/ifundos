...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    if (activeAct === 1) {
      setPipelinePhase(0);
      pipelineTimers.current.push(setTimeout(() => setPipelinePhase(1), 100));
      pipelineTimers.current.push(setTimeout(() => setPipelinePhase(2), 300));
      pipelineTimers.current.push(setTimeout(() => setPipelinePhase(3), 600));
      pipelineTimers.current.push(setTimeout(() => setPipelinePhase(4), 1200));
      pipelineTimers.current.push(setTimeout(() => setPipelinePhase(5), 1600));
    } else {
      setPipelinePhase(0);
    }
